...
function assertFhevmStoredPublicKey(
  ...
  if (typeof (value as { publicKeyId: unknown }).publicKeyId !== "string") {
  ...
  if (!((value as { publicKey: unknown }).publicKey instanceof Uint8Array)) {
...
function assertFhevmStoredPublicParams(
  ...
  if (
    typeof (value as { publicParamsId: unknown }).publicParamsId !== "string"
  ) {
  ...
  if (
    !((value as { publicParams: unknown }).publicParams instanceof Uint8Array)
  ) {
    throw new Error(
